...
dotnet ef dbcontext scaffold %CONNECTION% --context SampleEntities --startup-project Bhbk.Lib.DataAccess.EFCore.Tests --project Bhbk.Lib.DataAccess.EFCore.Tests --output-dir Models --use-database-names --verbose  --no-onconfiguring --force
set CONNECTION=
