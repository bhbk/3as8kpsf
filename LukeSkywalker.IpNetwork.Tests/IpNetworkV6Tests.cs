...
namespace LukeSkywalker.IPNetwork.Tests
{
    ...
    public class IpNetworkV6Tests
    {
        ...
        public void TryToNetmask1()
        {
            ...
            bool parsed = IPNetwork.TryToNetmask(0, System.Net.Sockets.AddressFamily.InterNetworkV6, out result);
        ...
        {
            IPAddress result = null;
            bool parsed = IPNetwork.TryToNetmask(33, System.Net.Sockets.AddressFamily.InterNetworkV6, out result);
        ...
        public void ToNetmask128()
        {
            ...
            byte cidr = 128;
            string netmask = "ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff";
            string result = IPNetwork.ToNetmask(cidr, System.Net.Sockets.AddressFamily.InterNetworkV6).ToString();
        ...
        public void TryParseCidr1()
        {
            ...
            byte? cidr;
            byte? result = 0;
            bool parsed = IPNetwork.TryParseCidr(sidr, System.Net.Sockets.AddressFamily.InterNetworkV6, out cidr);
