...
namespace LukeSkywalker.IPNetwork.Tests
{
    ...
    public class IpNetworkV4Tests
    {
        ...
        {
            BigInteger result = IPNetwork.ToUint(33, System.Net.Sockets.AddressFamily.InterNetwork);
        }

        [TestMethod]
        public void TestToBigIntegerByte2()
        {
            BigInteger result = IPNetwork.ToUint(32, System.Net.Sockets.AddressFamily.InterNetwork);
        ...
        {
            BigInteger result = IPNetwork.ToUint(0, System.Net.Sockets.AddressFamily.InterNetwork);
            uint expected = 0;
            Assert.AreEqual(expected, result, "result");
        ...
        public void TryToNetmask1()
        {
            ...
            bool parsed = IPNetwork.TryToNetmask(0, System.Net.Sockets.AddressFamily.InterNetwork, out result);
        ...
        {
            IPAddress result = null;
            bool parsed = IPNetwork.TryToNetmask(33, System.Net.Sockets.AddressFamily.InterNetwork, out result);
        ...
        public void ToNetmask32()
        {
            ...
            byte cidr = 32;
            string netmask = "255.255.255.255";
            string result = IPNetwork.ToNetmask(cidr, System.Net.Sockets.AddressFamily.InterNetwork).ToString();
        ...
        public void TestTrySupernetArray4()
        {
            ...
            IPNetwork ipnetwork1 = IPNetwork.Parse("192.168.0.0/24");
            IPNetworkCollection subnetted = IPNetwork.Subnet(ipnetwork1, 32);
...
".Replace("\r", "");
        ...
        **/
        ...
        public void TryParseCidr1()
        {
            ...
            byte? cidr;
            byte? result = 0;
            bool parsed = IPNetwork.TryParseCidr(sidr, System.Net.Sockets.AddressFamily.InterNetwork, out cidr);
