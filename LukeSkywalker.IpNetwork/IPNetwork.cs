...
namespace LukeSkywalker.IPNetwork
{
    ...
    public class IPNetwork : IComparable<IPNetwork>
    {
        ...
        public IPAddress LastUsable
        {
            get
            {
                BigInteger last = this._family == System.Net.Sockets.AddressFamily.InterNetworkV6
                    ? this._broadcast
        ...
        public static string Print(IPNetwork ipnetwork)
        {
            ...
            sw.WriteLine("CidrParser        : {0}", ipnetwork.Cidr);
        ...
        public static bool TrySubstractNetwork(IpNetwork[] ipnetworks, IpNetwork substract, out IEnumerable<IpNetwork> result) {
            ...
            foreach (var ipn in ipnetworks) {
                ...
                var collection = IpNetwork.Subnet(ipn, substract.CidrParser);
        ...
        public Int32 CompareTo(Object obj)
        {
            ...
            //  convert to a proper CidrParser object
