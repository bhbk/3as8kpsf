...
BOOL WINAPI DetourCreateProcessWithDllAsUserA(HANDLE lpToken,
										LPCSTR lpApplicationName,
                                        ...
                                        LPCSTR lpDllName,
                                        PDETOUR_CREATE_PROCESS_AS_USER_ROUTINEA pfCreateProcessAsUserA);

BOOL WINAPI DetourCreateProcessWithDllAsUserW(HANDLE lpToken,
										LPCWSTR lpApplicationName,
                                        ...
                                        LPCSTR lpDetouredDllFullName,
                                        LPCSTR lpDllName,
                                        PDETOUR_CREATE_PROCESS_AS_USER_ROUTINEW pfCreateProcessAsUserW);

#ifdef UNICODE
#define DetourCreateProcessWithDllAsUser  DetourCreateProcessWithDllAsUserW
#define PDETOUR_CREATE_PROCESS_AS_USER_ROUTINE     PDETOUR_CREATE_PROCESS_AS_USER_ROUTINEW
#else
#define DetourCreateProcessWithDllAsUser  DetourCreateProcessWithDllAsUserA
